...
<?php echo '
<form method="post" action="index.php?step=1_3_101">
<table cellpadding="2" cellspacing="0" border="1" align="center" height="auto">
	...
	<tr>
		...
		<td>Порядковий номер книжки МДП <input type="text" size="16" name="order_number_mdp" value=""></td>
	</tr>
	<tr>
		<tr>
	...
	<tr>
		<td colspan="2">Вантаж <input type="text" size="25" name="vantag" value=""> Вага, кг <input type="text" size="5" name="weight" value=""> К-ть місць/шт <input type="text" size="5" name="seat" value=""> Пломба <input type="text" size="7" name="seal" value="1х204/"></td>
	</tr>
	<tr>
	...
	<tr>
		<td colspan="2">Посадова особа <input type="text" size="20" name="rank_person" value="'.IdentToNameUniversal($_SESSION['iduser'],'ident','users',$field='name').' '.IdentToNameUniversal($_SESSION['iduser'],'ident','users',$field='second_name'). '"></td>
	</tr>
	<tr>
