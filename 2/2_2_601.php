...
$sql="select * from main_mdp_in where number_registr like '$number'";
...
<form method="post" action="index.php?step=2_2_602">
<table cellpadding="2" cellspacing="0" border="1" align="center" height="auto">
	...
	<tr>
		...
		<td>Порядковий номер книжки МДП <input type="text" size="13" name="number_registr" value="'.$row['number_registr'].'"></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td>Отримувач <input type="text" size="20" name="recipient" value="'.$row['reciient'].'"></td>
	</tr>
	<tr>
	<tr>
		<td>Відправник <input type="text" size="25" name="sender" value="'.$row['sender'].'"></td>
		<td>Отримувач <input type="text" size="40" name="recipient" value="'.$row['recipient'].'"></td>
	</tr>
	...
	<tr>
		<td>Посадова особа <input type="text" size="15" name="rank_person" value="'.$row['rank_person'].'"></td>
		<td>Примітки <input type="text" size="40" name="remark" value="'.$row['remark'].'"></td>
	</tr>
	<tr>
