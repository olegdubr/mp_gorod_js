...
(function ($) {
    ...
    var methods = {
        init: function (options) {
            ...
            return this.each(function () {
                ...
                if (settings.allowNewElements) {
                    selectElement.prepend('<option>новий запис</option>');
                }
                ...
                selectElement.keydown(function (e) {
                    ...
                    if (e.keyCode == "46") { // del-button
                        if (selected != "новий запис") {
                            $(this).children("option:selected").remove();
                        }
                        return;
                    }

                    if (selected == "новий запис" || settings['editableElements']) {
        ...
        enableAddingNewElements: function () {
            var fChild = $(this).children().first();
            if (fChild.text() != "новий запис") {
                $(this).prepend('<option>новий запис</option>');
            }
        },
